...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=8, dilation=1, norm_layer=None):
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.layer1 = self._make_layer(block, 8, num_channels, num_blocks)
...
def hrnet18(in_channels=3, out_classes=16, **kwargs):
    r"""HRNet-18 model
    """
    from .hrnet_config import HRNET_18
    model = HighResolutionNet(HRNET_18, in_channels=in_channels, out_classes=out_classes)
    return model
